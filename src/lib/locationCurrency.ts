...
export const countryCurrencyMap: Record<string, {
  ...
  ZW: { currency: "ZWL", symbol: "$" },
};

export const countryCodes = Object.keys(countryCurrencyMap);
